...
export const AISettings: React.FC = () => {
  ...
  return (
    <div className="w-full bg-white rounded-3xl border border-[#E2EAE6] p-6 sm:p-8 shadow-[0_8px_30px_rgba(1,59,35,0.03)] space-y-7">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[#E2EAE6]">
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-[#FAF5FF] text-[#9333EA] border border-[#E9D5FF] flex items-center justify-center font-bold shadow-2xs">
        ...
        <Button
          ...
          className="font-bold text-xs sm:text-sm px-6 rounded-xl shadow-xs self-start sm:self-auto"
        >
      ...
      {/* Info Banner */}
      <div className="p-4 bg-[#F0FDF4] border border-[#BBF7D0] rounded-2xl text-xs sm:text-sm text-[#166534] flex items-center gap-3 font-medium shadow-2xs">
        <div className="w-8 h-8 rounded-xl bg-white text-[#16A34A] flex items-center justify-center shrink-0 border border-[#BBF7D0]">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 rounded-2xl bg-[#FAFDFB] border border-[#E2EAE6] space-y-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full h-11 px-3.5 rounded-xl border border-[#E2EAE6] bg-white text-xs font-bold text-[#14201C] focus:outline-none focus:border-[#05A222] transition-colors"
            >
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 bg-[#FAFDFB] rounded-2xl border border-[#E2EAE6]">
          <div className="space-y-1">
            ...
            <p className="text-xs text-[#5F7069] max-w-xl font-medium">
      ...
      <div className="pt-4 border-t border-[#E2EAE6] flex justify-end">
        <Button
          ...
          isLoading={isSaving}
          leftIcon={<Save className="w-4 h-4" />}
          className="font-bold text-sm px-8 rounded-xl shadow-xs cursor-pointer"
        >
