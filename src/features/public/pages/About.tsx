  ...
  return (
    <div className="bg-white text-[#1F2A26]">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        {/* Meta Cloud API Integration Story */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-4">
              ...
              <p className="text-xs sm:text-sm text-[#5F7069] leading-relaxed">
                Unlike legacy aggregators that route messages through unpredictable intermediary SMS gateways, {APP_NAME} connects your business directly to Meta's Cloud API infrastructure. This guarantees unmatched delivery speeds, automatic green tick verification pathways, and standard Meta pricing.
              </p>
