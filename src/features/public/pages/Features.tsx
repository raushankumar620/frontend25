...
export const Features: React.FC = () => {
  ...
  const deepDives = {
    api: {
      ...
      title: 'Native Meta Cloud API Direct Integration',
      description: 'Zero third-party broker latency. Transmit over 100,000 marketing, transactional, and utility messages per day with Meta green tick guidance.',
      points: [
      ...
      <section className="relative overflow-hidden w-full border-b border-[#C4EBD0]/70 py-16 sm:py-20 lg:py-24 bg-[#EBF7EE]">
        <div className="absolute inset-0 z-0 pointer-events-none select-none">
          <img 
            ...
            alt="WhatsAppMSG Features Header" 
