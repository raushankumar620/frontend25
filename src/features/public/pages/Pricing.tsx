  ...
  const faqs = [
    {
      ...
      a: 'WhatsAppMSG connects directly to your Meta Business Manager. Meta charges for conversation sessions (Marketing, Utility, Authentication, Service) directly to your payment method at standard Meta rates with zero markup or hidden broker fees.',
    },
    {
      q: 'Can I keep my existing WhatsApp Business number?',
      a: 'Yes! You can migrate your existing phone number or register a brand new landline or virtual number. We guide you step-by-step through Meta Cloud API onboarding without losing your business identity.',
    },
    {
