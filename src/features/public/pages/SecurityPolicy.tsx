...
export const SecurityPolicy: React.FC = () => {
  ...
  const sections = [
    ...
    { id: 'meta-cloud', title: '3. Direct Meta Cloud Pipeline' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <main className="lg:col-span-8 space-y-12 text-sm sm:text-base text-[#4A5D54] leading-relaxed">
            ...
            <section id="meta-cloud" className="scroll-mt-28 space-y-4">
              <h2 className="text-xl sm:text-2xl font-bold text-[#14201C] tracking-tight">
                3. Direct Meta Cloud Pipeline
              </h2>
              <p>
                {APP_NAME} connects directly to Meta’s high-throughput <strong>Cloud API</strong>, handling up to 100,000+ customer conversations per day per phone number with sub-second delivery latency.
              </p>
